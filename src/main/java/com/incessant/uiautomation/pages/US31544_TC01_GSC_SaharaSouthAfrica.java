...
public class US31544_TC01_GSC_SaharaSouthAfrica {
	
	
	@Test
	public void US31544_TC01_GSC_SaharaSouthAfrica() throws Exception  {
		...
		opencustomerurl.Customer_URLS(driver,"Sub Sahara South Africa");
      ...
      //  driver.manage().window().maximize();
		...
		ProcessFlowActions.validateCustomerWorkBasketSA(driver);
