...
import com.incessant.uiautomation.util.XLReader;
	...
	public class US31550_Techpubs_support  extends TestBaseCommon{
		@Test
		public void US31550_Techpubs_support() throws Exception {
...
//       WebDriver driver = new ChromeDriver(options);  
		...
		opencustomerurl.Customer_URLS(driver,"TechPubs");
		...
		ProcessFlowActions.TechPubs_CountryCaseIDSearchInCCMS(driver);
