...
public class TestNewISGCase extends TestBaseCommon {
//US21375_ISG

		@Test
		public void createISGCaseByUser_US21375() throws IOException {
			...
			ProcessFlowActions.createISGCaseByUser(driver);
