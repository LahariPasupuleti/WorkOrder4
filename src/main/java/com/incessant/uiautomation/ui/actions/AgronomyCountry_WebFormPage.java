...
public class AgronomyCountry_WebFormPage {
...
//	By ISG_TransferButton=By.xpath(locators.getProperty("ISG_TransferButton"));
	 ...
	 */
	public void AgronomyCountry_WebFormsSubmit(WebDriver driver) throws Exception {
...
//		System.out.println("click on  signIn Button ");
		...
		FileWriter fw=new FileWriter(FwConstants.Agronomy_CaseID);    
        fw.write(Case_ID);    
        fw.close();  
		
	}
	public void AgronomyCountry_CaseIDRouting(WebDriver driver) throws Exception {
	Thread.sleep(1000);
	
//	String filepath="FwConstant.Agronomy_CaseID";
	Scanner myScanner = new Scanner(new File(FwConstants.Agronomy_CaseID));
	String caseid = null;
   ...
   System.out.println(""+workbasket);
	...
	public AgronomyCountry_WebFormPage(WebDriver driver) {
		this.driver = driver;
	}
