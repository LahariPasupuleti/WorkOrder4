...
public class JDLink_Dashboard_US31545 {
...
//	By ISG_Action=By.xpath(locators.getProperty("ISG_Action"));
	...
	By WorkbasketName=By.xpath(locators.getProperty("WorkbasketName"));
	
	
	
	//JDLDashboard_paths
			By JDLDashboard_LangSelector=By.xpath(locators.getProperty("JDLDashboard_LangSelector"));
...
//			By JDLDashboard_Validating_file=By.xpath(locators.getProperty("JDLDashboard_Validating_file"));
	...
	public void webform_US31545(WebDriver driver) throws AWTException, InterruptedException {
		Thread.sleep(3000);
...
//		System.out.println("" +Disp_msg);
		...
		new Select(driver.findElement(JDLDashboard_SelectProduct)).selectByValue("JDLink Dashboard");
		//Enter machine pin
		driver.findElement(JDLDashboard_MachinePIN).sendKeys("12345");
		
		//Comments/questions
		driver.findElement(JDLDashboard_Description).sendKeys("This is Sample Stellar Support ISG");
...
//		System.out.println(""+Val_attach);
		...
		Case_ID = strArr[8];
         ...
         try {
             ...
             fw = new FileWriter(new File(FwConstants.JDLink_CaseID));
...
public void case_search_isg(WebDriver driver) {
		...
		String WorkBasket= driver.findElement(WorkbasketName).getText();
